...
public class CameraShake : MonoBehaviour
{
    ...
    public float smoothAmount = 4f;//Amount to smooth
    ...
    void Shake2()
    {
            ...
            shakeDuration = 1;// Mathf.Lerp(shakeDuration, 0, Time.deltaTime);//Lerp the time, so it is less and tapers off towards the end.
